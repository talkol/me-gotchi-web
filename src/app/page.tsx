      ...
      <header className="bg-yellow-400 px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-medium text-purple-900">Me-gotchi</span>
          </div>
          
          {/* CTA Button */}
          <Button asChild className="text-1xl bg-teal-400 hover:bg-teal-500 text-purple-900 font-medium rounded-full px-6 py-2">
      ...
      <section className="bg-teal-400 py-0 px-6">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-between">
          <div className="lg:w-1/2 mb-10 lg:mb-0">
            <h1 className="text-5xl lg:text-7xl font-medium text-purple-900 mb-8">
            ...
            <Button asChild className="bg-yellow-400 hover:bg-yellow-500 text-purple-900 font-medium text-lg px-8 py-4 rounded-full">
