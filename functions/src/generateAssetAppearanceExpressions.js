      ...
      input: [
        {
          ...
          content: [
            {
              type: "input_text",
              text: `Create a square 1:1 image with transparent background and divide it into 9 equal squares. In each square put the exact face of the input character with a different varied facial expression and maintain the same exact art style of the original. Top row: big smile with mouth closed, eyes open; bigger happier smile with mouth slightly open, eyes open; huge laugh with mouth open, eyes closed. Middle row: no smile, eyes looking top left; no smile, eyes looking straight; no smile, eyes looking bottom right. Bottom row: big sad frown, eyes open; huge angry frown, eyes open; huge frown crying, eyes closed and tears. Make sure all facial expressions are different. Do not put any separator lines between frames. Maintain the exact art style of the original and same level of detail. Make sure the top of the head is fully visible in each frame and that there is no overlap between frames.`,
            },
            {
              type: "input_image",
